...
func (t Tag) List(c *gin.Context) {
	...
	if err != nil {
		logrus.WithContext(c).Errorf("svc.CountTag err: %v", err)
		response.ToErrorResponse(errcode.ErrorCountTagFail)
		return
	}
	tags, err := svc.GetTagList(&param, &pager)
	if err != nil {
		logrus.WithContext(c).Errorf("svc.GetTagList err: %v", err)
...
func (t Tag) Create(c *gin.Context) {
	...
	if err != nil {
		logrus.WithContext(c).Errorf("svc.CreateTag err: %v", err)
...
func (t Tag) Update(c *gin.Context) {
	...
	if err != nil {
		logrus.WithContext(c).Errorf("svc.UpdateTag err: %v", err)
...
func (t Tag) Delete(c *gin.Context) {
	...
	if err != nil {
		logrus.WithContext(c).Errorf("svc.DeleteTag err: %v", err)
